...
var MonsterInsights = function() {
        ...
        function A(e) {
            ...
            if (d.match(/^javascript\:/i)) {
                ...
                t = 'mailto'
            } else if (r && v && r.length > 0 && v.length > 0 && !r.endsWith('.' + v) && r !== v) {
                t = 'external'
            ...
            if (m && (t === 'unknown' || 'external' === t) && f.length > 0 && m.length > 0) {
                    ...
                    if (K || o == 'mailto' || o == 'tel') {
                        if (o == 'download') {
                            ...
                            k = {
                                ...
                                email_address: m.replace('mailto:', ''),
        ...
        if (a.addEventListener) {
            a.addEventListener('load', function() {
                document.body.addEventListener('click', m, !1)
            }, !1);
            window.addEventListener('hashchange', k, !1)
        } else {
            if (a.attachEvent) {
                a.attachEvent('onload', function() {
                    document.body.attachEvent('onclick', m)
                });
